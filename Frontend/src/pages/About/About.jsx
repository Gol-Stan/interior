        ...
        <div className='about-page'>
            ...
            <div className='container my-5'>
                <div className='row'>
                    <div className='col-lg-6 d-flex flex-column justify-content-center mb-4 mb-lg-0'>
                        <h2 className='mb-4 mb-lg-5'>{t("about.study_title")}</h2>
                        <p>{t("about.study_p1")}</p>
                        <p className='mb-4 mb-lg-5'>{t("about.study_p2")}</p>
                        <Link to='/contact'>
                            <button type='button' className='btn btn-danger btn-lg mx-o mx-sm my-2 my-sm-0'>{t("about.contact_btn")}</button>
                        </Link>
                    </div>
            ...
            <div className='bg-body-tertiary py-5'>
                <div className='container'>
                    <h2 className='text-center mb-5'>{t("about.clients_title")}</h2>
